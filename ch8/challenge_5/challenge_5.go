...
func tagger(msg sms) []string {
	...
	if !strings.Contains(lowerContent, "urgent") && !strings.Contains(lowerContent, strings.ToLower("promo")) && !strings.Contains(lowerContent, strings.ToLower("sale")) {
		return tags
	}
	...
	if strings.Contains(lowerContent, strings.ToLower("promo")) || strings.Contains(lowerContent, strings.ToLower("sale")) {
